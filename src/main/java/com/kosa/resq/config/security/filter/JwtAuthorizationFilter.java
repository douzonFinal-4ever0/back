...
import com.kosa.resq.config.security.code.ErrorCode;
import com.kosa.resq.config.security.exception.BusinessExceptionHandler;
            ...
            if (header != null && !header.equalsIgnoreCase("")) {
                ...
                if (TokenUtil.isValidToken(token)) {
                    ...
                    if (userId != null && !userId.equalsIgnoreCase("")) {
                        ...
                        // [STEP6] 실제 DB로 조회를 하여 유효한 사용자 인지 확인(인증)하는 부분이 들어가면 될것 같습니다.
                        chain.doFilter(request, response);
                    } else {
